...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            DateTime StartDate1 = new DateTime(2009, 11, 1);
            DateTime EndDate1 = new DateTime(2009, 11, 30);

            DateTime StartDate2 = new DateTime(2010, 11, 1);
            DateTime EndDate2 = new DateTime(2010, 11, 30);

            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(StartDate1, EndDate1, 0);
            var remainingFlight = new Flight(StartDate2, EndDate2, 0);
